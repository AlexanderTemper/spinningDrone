...
// Nop
#elif defined(SAMD20J18)

//#include "stm32f10x_conf.h"
//#include "stm32f10x_gpio.h"
//#include "core_cm3.h"

// Chip Unique ID on SAMD20
#define U_ID_0 (*(uint32_t*)0x0080A00C)
#define U_ID_1 (*(uint32_t*)0x0080A040)
#define U_ID_2 (*(uint32_t*)0x0080A044)
#define U_ID_3 (*(uint32_t*)0x0080A048)
#else // STM32F10X
