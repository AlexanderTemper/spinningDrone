...
#define startTimeout() (g_timeoutStartMs = getTimeMs())

// Check if timeout is enabled (set to nonzero value) and has expired
#define checkTimeoutExpired() (g_ioTimeout > 0 && ((uint16_t)getTimeMs() - g_timeoutStartMs) > g_ioTimeout)
...
//---------------------------------------------------------
VL53L0X_Error writeReg(uint8_t reg, uint8_t value);        // Write an 8-bit register
VL53L0X_Error writeReg16Bit(uint8_t reg, uint16_t value);  // Write a 16-bit register
VL53L0X_Error writeReg32Bit(uint8_t reg, uint32_t value);  // Write a 32-bit register
