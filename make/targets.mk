...
SAMD20_TARGETS  := $(SAMD20J18_TARGET)
...
ifeq ($(filter $(TARGET),$(F1_TARGETS) $(F3_TARGETS) $(F4_TARGETS) $(F7_TARGETS) $(SITL_TARGETS) $(SAMD20_TARGETS)),)
$(error Target '$(TARGET)' has not specified a valid STM group, must be one of F1, F3, F405, F411, F7x5 or SAMD20. Have you prepared a valid target.mk?)
endif
...
else ifeq ($(TARGET),$(filter $(TARGET), $(SAMD20J18_TARGET)))
